...
%save_path='.\save_path_icp\';%输出path
...
fst_frame = 139; nt_frames = nimages-1;% for icp 叠加，从第二帧开始，用上一帧叠加当前帧
...
for frame = fst_frame: 1: nt_frames
    ...
    [velo,rmse]=lidar_merge_cpd(velo_c,velo_l);
    ...
    writelabels(save_path,seq_idx,info_str,'cpd');
end
end
